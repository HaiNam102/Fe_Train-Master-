  ...
  const fetchTrackingData = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        `http://localhost:8080/clientstracking/getClientsTrackingById/${trackingId}`
      );
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      await axiosInstance.put(
        `http://localhost:8080/clientstracking/updateTrackingById/${trackingId}`,
        updatedData
      );
        ...
        <form className="row g-3">
          ...
          <div className="col-md-12">
            ...
            <input
              ...
              onChange={(e) =>
                setTrackingData({ ...trackingData, weight: e.target.value })
              }
            />
          </div>
          <div className="col-md-12">
            ...
            <input
              ...
              onChange={(e) =>
                setTrackingData({ ...trackingData, sleepHour: e.target.value })
              }
            />
          </div>
          <div className="col-md-12">
            ...
            <input
              ...
              onChange={(e) =>
                setTrackingData({ ...trackingData, stepCount: e.target.value })
              }
            />
          </div>
          <div className="col-md-12">
            ...
            <textarea
              ...
              onChange={(e) =>
                setTrackingData({ ...trackingData, notes: e.target.value })
              }
            />
          </div>
        </form>
